...
markdown_file = "D:\\Grado Superior\\2.Segundo\\AccesoADatos\\ProyectoFinal\\Documentos\\Documentacion.md"
with open(markdown_file, "w", encoding="utf-8") as md_file:
    for page_num in range(len(doc)):
        ...
        for img_index, img in enumerate(image_list):
            ...
            image_path = os.path.join(os.path.dirname(markdown_file), image_filename)
            ...
            md_file.write(f"![Imagen {img_index + 1}](./{image_filename})\n\n")
